...
attribute float a_lifeTime; // время жизни частицы в секундах
attribute vec3 a_startPosition; // начальное положение частицы в момент взрыва
attribute vec3 a_endPosition; // конечное положение частицы
