...
public class Diffuse extends Object3D implements Asteroid {
    ...
    public Diffuse(double versionGL, Context context, float scale, String objectPath) { //, TypeAsteroid type) {
        ...
        if (versionGL == 2.0) {
            ...
            linkProgram = new LinkedProgram(context,
                    "shaders/gles30/diffuse_v.glsl",
                    "shaders/gles30/diffuse_f.glsl");
        }
    ...
    public void setView(View3D view) {
        if (view instanceof DiffuseView3D) this.view = (DiffuseView3D) view;
    }
