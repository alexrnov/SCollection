...
public class Wave extends BackgroundObject3D {
  ...
  public Wave(double versionGL, Context context, float scale, int textureIDResource) {
    ...
    if (versionGL == 2.0) {
      ...
      linkProgram = new LinkedProgram(context,
              "shaders/gles30/wave_v.glsl",
              "shaders/gles30/wave_f.glsl");
    }
