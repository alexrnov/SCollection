...
public class Wave2 extends BackgroundObject3D {
  ...
  public Wave2(double versionGL, Context context, float scale, int textureIDResource) {
    ...
    if (versionGL == 2.0) {
      ...
      linkProgram = new LinkedProgram(context,
              "shaders/gles30/wave2_v.glsl",
              "shaders/gles30/wave2_f.glsl");
    }
