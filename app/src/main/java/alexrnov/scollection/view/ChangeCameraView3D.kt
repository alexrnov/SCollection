 ...
 * классах-наследниках.
 */
abstract class ChangeCameraView3D(var x: Float, var y: Float, var z: Float, val widthScreen: Int, private val heightScreen: Int) {
  //var x: Float = 0.0f
  //var y: Float = 0.0f
  //var z: Float = -2.0f
  ...
  init {
    ...
    Matrix.setLookAtM(viewMatrix, 0, 0.0f, -3.0f, 2.0f,
            0f, 0f, -2.0f, 0f, 1.0f, 0.0f)
  ...
  */
  private fun setPerspectiveProjection() {
     ...
     * Что-бы перспективы не было вовсе, нужно установить значение near = 10.0f
     */
    val near = 1.0f
